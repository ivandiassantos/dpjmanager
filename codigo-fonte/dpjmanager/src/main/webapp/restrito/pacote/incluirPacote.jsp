...
<customTags:templateFuncionalidades nomeIconeFuncionalidade="icon-briefcase" tituloFuncionalidade="Incluir Pacote">
   <form:form cssClass="form-horizontal" servletRelativeAction="/pacote/cadastrarPacote" method="post">
		<input type="hidden" id="solicitacoes" name="solicitacoes"/>
		<fieldset>
			<div class="control-group">											
				<label class="control-label" for="nomePacote">Nome:</label>
				<div class="controls">
					<input type="text" class="span6" id="nomePacote" name="nomePacote" required maxlength="200"/>
				</div>		
			</div>
			<div class="control-group">											
				<label class="control-label" for="dataInicio">Data de Início:</label>
				<div class="controls">
					<input type="date" class="span6" id="dataInicio" name="dataInicio" required/>
				</div>		
			</div>
			<div class="control-group">											
				<label class="control-label" for="dataFinal">Data de Término:</label>
				<div class="controls">
					<input type="date" class="span6" id="dataFinal" name="dataFinal" required/>
				</div>		
			</div>
			<div class="control-group">											
